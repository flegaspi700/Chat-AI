...
const GenerateChatbotResponseInputSchema = z.object({
  ...
  fileContent: z.string().optional().describe('The content of the uploaded file, if any.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a helpful AI chatbot.  Use the content from the uploaded file (if any) and the user's input to generate a relevant and informative response.
